#' `r get_doc_title_md(get_model_spec('MODELCLASS'))`
#'
#' @description `r get_doc_description_md(get_model_spec('MODELCLASS'))`
#'
#' @param formula `r get_doc_formula_arg_md(get_model_spec('MODELCLASS'))`
...
#'
#' @details
#' `r get_doc_details_md(get_model_spec('MODELCLASS'))`
#'
#'
#'
#' @export

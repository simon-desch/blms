#' `r get_doc_title_md(get_model_spec('ql_a_2it'))`
#'
#' @description `r get_doc_description_md(get_model_spec('ql_a_2it'))`
#'
#' @param formula `r get_doc_formula_arg_md(get_model_spec('ql_a_2it'))`
...
#'
#' @details
#' `r get_doc_details_md(get_model_spec('ql_a_2it'))`
#'
#'
#'
#' @export

...
#' Rescorla-Wagner delta learning model with separate learning rates for positive and negative prediction errors and lapse parameter
#'
#' @param formula response formula specifying the response and its prediction.
#'        For models of class \code{'ql_2a_it'} this formula needs to define the

...
ql_2a_rho_fu_probs_func <-
  brms::stanvar(
    scode = '
  vector ql_2a_rho_fu_probs(vector block_grp, vector choice, vector reward, vector alphapos, vector alphaneg, vector rho) {
    int nT = size(choice);
    vector[nT] Ps_out;
...
ql_2a_2rho_fu_probs_func <-
  brms::stanvar(
    scode = '
  vector ql_2a_2rho_fu_probs(vector block_grp, vector choice, vector reward, vector alphapos, vector alphaneg, vector rhopos, vector rhoneg) {
    int nT = size(choice);
    vector[nT] Ps_out;

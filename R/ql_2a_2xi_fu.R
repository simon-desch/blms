#' `r get_doc_title_md(get_model_spec('ql_2a_2xi_fu'))`
#'
#' @description `r get_doc_description_md(get_model_spec('ql_2a_2xi_fu'))`
#'
#' @param formula `r get_doc_formula_arg_md(get_model_spec('ql_2a_2xi_fu'))`
...
#'
#' @details
#' `r get_doc_details_md(get_model_spec('ql_2a_2xi_fu'))`
#'
#'
#'
#' @export

#' `r get_doc_title_md(get_model_spec('hmm_rp'))`
#'
#' @description `r get_doc_description_md(get_model_spec('hmm_rp'))`
#'
#' @param formula `r get_doc_formula_arg_md(get_model_spec('hmm_rp'))`
...
#'
#' @details
#' `r get_doc_details_md(get_model_spec('hmm_rp'))`
#'
#'
#'
#' @export

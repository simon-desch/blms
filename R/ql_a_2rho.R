#' `r get_doc_title_md(get_model_spec('ql_a_2rho'))`
#'
#' @description `r get_doc_description_md(get_model_spec('ql_a_2rho'))`
#'
#' @param formula `r get_doc_formula_arg_md(get_model_spec('ql_a_2rho'))`
...
#'
#' @details
#' `r get_doc_details_md(get_model_spec('ql_a_2rho'))`
#'
#'
#'
#' @export

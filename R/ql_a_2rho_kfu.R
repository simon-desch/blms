#' `r get_doc_title_md(get_model_spec('ql_a_2rho_kfu'))`
#'
#' @description `r get_doc_description_md(get_model_spec('ql_a_2rho_kfu'))`
#'
#' @param formula `r get_doc_formula_arg_md(get_model_spec('ql_a_2rho_kfu'))`
...
#'
#' @details
#' `r get_doc_details_md(get_model_spec('ql_a_2rho_kfu'))`
#'
#'
#'
#' @export

...
#' positive and negative prediction errors and separate reward sensitivity
#' parameters for positive and negative outcomes
#'
#' @param formula response formula specifying the response and its prediction.
#'        For models of class \code{'ql_2a_2rho'} this formula needs to define the

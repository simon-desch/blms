#' `r get_doc_title_md(get_model_spec('qlddm_a'))`
#'
#' @description `r get_doc_description_md(get_model_spec('qlddm_a'))`
#'
#' @param formula `r get_doc_formula_arg_md(get_model_spec('qlddm_a'))`
...
#'
#' @details
#' `r get_doc_details_md(get_model_spec('qlddm_a'))`
#'
#'
#'
#' @export
